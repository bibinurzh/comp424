...
// tell the user to login
	...
	echo "<div class='alert alert-info'>
        <strong>Please login.</strong></div>";
}
 
// tell the user email is verified
else if($action=='email_verified'){
	echo "<div class='alert alert-success'>
        <strong>Your email address have been validated.</strong></div>";
}
...
echo "<div class='account-wall'>";
	echo "<div id='my-tab-content' class='tab-content'>";
			...
			echo "<div align='center'>
                	<img class='profile-img' src='images/login-icon.png'></div>";
                		echo "<form class='form-signin' action='" . htmlspecialchars($_SERVER["PHP_SELF"]) . "' method='post'>";
                    			echo "<input type='text' name='username' class='form-control' placeholder='Username' required autofocus />";
                    				echo "<input type='password' name='password' class='form-control' placeholder='Password' required />";
                    					echo "<input type='submit' class='btn btn-lg btn-primary btn-block' value='Login' />";
		    						echo "<div align='center'>
   		    						<br><a href='{$home_url}forgot_username'>Forgot Username?</br></a>
								</div>";
		    							echo "<div align='center'>
